...
Page({
    data: {
        chatMsg: [],
        emojiStr: '',
        yourname: group_id,  //发送对象为群id
        myName: wx.getStorageSync("nickName"),  //昵称
        headImg:'',
        sendInfo: '',
        userMessage: '',
        inputMessage: '',
    ...
    onLoad: function (options) {
        var that = this
        //console.log(options)
        var myName = wx.getStorageSync("nickName");
    ...
    sendMessage: function () {
        ...
        console.log('myName:' + myName + "id:" + id + "msg:" + msg);
        console.log("that.data.sendInfo:" + that.data.sendInfo + "that.data.group_id:" + that.data.group_id) ;
        var option = {
          msg: that.data.sendInfo,
          to: that.data.group_id,  //groupId
          roomType: true,
          chatType: 'chatRoom',
       ...
       // msg.body.chatType = 'groupchat';
        ...
        if (msg) {
            ...
            that.data.chatMsg.push(msgData)
            console.log('chatMsg' + JSON.stringify(that.data.chatMsg))
            wx.setStorage({
                key: that.data.yourname + myName,
                data: that.data.chatMsg,
                success: function () {
    ...
    sendImage: function () {
        ...
        console.log('pages' + JSON.stringify(pages[1]))
        //pages[1].cancelEmoji()
        wx.chooseImage({
            count: 1,
